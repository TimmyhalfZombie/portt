...
export const metadata: Metadata = {
  title: 'Shemuel | Portfolio',
  description:
    'Check out modern and stylish portfolio of an experienced Web Developer Shemuel Rei Lagrosa! Built using TypeScript, Next.js 14, Framer Motion and Tailwind CSS.',
};
